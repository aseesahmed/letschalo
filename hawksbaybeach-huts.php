        ...
        <section class="page">
            ...
            <div class="page-header" style="background-image:url(assets/images/header-1.jpg)">
                <div class="container text-center">
                    <h2 class="title top-trending-heading">Hawksbay Beach-huts</h2>
                    <!-- <h4><span>It's Rent 25, 000</span><span>/ 10Hrs</span></h4> -->
                </div>
            </div>
            ...
            <?php include('include/product-description.php'); ?>
...
Calendar.prototype.renderEvents = function(events, ele) {
  ...
  if(!events.length) {
    ...
    var span = createElement('span', '', 'Book Now');
