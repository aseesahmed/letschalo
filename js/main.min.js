...
$(function() {
    ...
    c.click(function() {
        ...
        n.hasClass("active") ?
            (t.removeClass("box-wrapper-selected"), n.removeClass("active")) :
            (t.addClass("box-wrapper-selected"),
    ...
    $(".qty-plus")
        ...
        .on("click", function(n) {
            ...
            isNaN(i) ||
                ((u = !1),
                    (t = 0),
                    f.hasClass("qty-plus") && i < 12 && ((t = i + 1), (u = !0)),
                    f.hasClass("qty-minus") && i > 0 && ((t = i - 1), (u = !0)),
                    u && (r.data("value", t), $(e).val(e + "-" + t), r.val(t), k()));
        });
});
